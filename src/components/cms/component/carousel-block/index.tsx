 ...
 * 
 */
export const CarouselBlockComponent : CmsComponent<CarouselBlockDataFragment> = ({ data, editProps }) => {
...
CarouselBlockComponent.displayName = "Carousel (_component/CarouselBlock)"
