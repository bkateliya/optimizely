...
export type AnimatedHeadingStylesComponentProps<DT extends Record<string, unknown> = Record<string, unknown>> = Omit<CmsComponentProps<DT, AnimatedHeadingStylesProps>,'children'> & JSX.IntrinsicElements['div']
export type AnimatedHeadingStylesComponent<DT extends Record<string, unknown> = Record<string, unknown>> = ComponentType<AnimatedHeadingStylesComponentProps<DT>>
...
export type HeadingStylesComponentProps<DT extends Record<string, unknown> = Record<string, unknown>> = Omit<CmsComponentProps<DT, HeadingStylesProps>,'children'> & JSX.IntrinsicElements['div']
export type HeadingStylesComponent<DT extends Record<string, unknown> = Record<string, unknown>> = ComponentType<HeadingStylesComponentProps<DT>>
...
export type HeadingElementComponentProps<DT extends Record<string, unknown> = Record<string, unknown>> = Omit<CmsComponentProps<DT, HeadingElementLayoutProps>,'children'> & JSX.IntrinsicElements['div']
export type HeadingElementComponent<DT extends Record<string, unknown> = Record<string, unknown>> = ComponentType<HeadingElementComponentProps<DT>>
