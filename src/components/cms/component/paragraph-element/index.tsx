 ...
 * 
 */
export const ParagraphElementComponent : CmsComponent<ParagraphElementDataFragment, ParagraphElementLayoutProps> = ({ data, layoutProps, editProps }) => {
...
ParagraphElementComponent.displayName = "Paragraph (_component/ParagraphElement)"
