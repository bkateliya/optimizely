 ...
 * 
 */
export const MenuNavigationBlockComponent : CmsComponent<MenuNavigationBlockDataFragment> = ({ data, editProps }) => {
...
MenuNavigationBlockComponent.displayName = "Menu navigation (_component/MenuNavigationBlock)"
