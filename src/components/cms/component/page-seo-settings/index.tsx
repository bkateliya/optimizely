 ...
 * 
 */
export const PageSeoSettingsComponent : CmsComponent<PageSeoSettingsDataFragment> = ({ data, editProps }) => {
...
PageSeoSettingsComponent.displayName = "Page SEO Settings (_component/PageSeoSettings)"
