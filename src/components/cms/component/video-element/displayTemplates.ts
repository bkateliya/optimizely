...
export type DefaultVideoComponentProps<DT extends Record<string, unknown> = Record<string, unknown>> = Omit<CmsComponentProps<DT, DefaultVideoProps>,'children'> & JSX.IntrinsicElements['div']
export type DefaultVideoComponent<DT extends Record<string, unknown> = Record<string, unknown>> = ComponentType<DefaultVideoComponentProps<DT>>
...
export type VideoElementComponentProps<DT extends Record<string, unknown> = Record<string, unknown>> = Omit<CmsComponentProps<DT, VideoElementLayoutProps>,'children'> & JSX.IntrinsicElements['div']
export type VideoElementComponent<DT extends Record<string, unknown> = Record<string, unknown>> = ComponentType<VideoElementComponentProps<DT>>
